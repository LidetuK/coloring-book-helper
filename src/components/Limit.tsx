...
import { Calendar, Truck, Gift } from "lucide-react";
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 relative z-10">
            <div className="flex-1 text-center md:text-left">
              ...
              Don’t miss out on unlocking the 11 Secret Strategies for unstoppable success, limitless abundance, and ultimate swagger in your life. <span className="font-bold underline"></span> and get <span className="font-bold"></span>
              </p>
