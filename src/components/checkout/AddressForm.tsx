...
const AddressForm = ({ formData, handleChange, setFormData, productType, step = 0 }: AddressFormProps) => {
  ...
  } else if (step === 3 && (productType === 'physical' || productType === 'bundle' || productType === 'dual-books')) {
