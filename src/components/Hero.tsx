    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-[#3A0233] pt-10 md:pt-16 px-4 text-white overflow-hidden">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="space-y-1 md:space-y-2 mt-4">
          <p className="text-2xl sm:text-3xl md:text-7xl font-bold leading-tight md:leading-[1.3]">
        ...
        <div className="text-[#ffffff] uppercase tracking-widest mt-4 md:mt-6 space-y-2 md:space-x-4">
          <span className="block md:inline text-xl sm:text-2xl md:text-4xl font-bold leading-tight">
            Why? Because Swaggerism isn't just a mindset
          </span>
          <span className="block md:inline text-sm sm:text-base md:text-xl font-bold">
        ...
        <div className="relative flex items-center justify-center mt-4 md:mt-6 w-full">
          <img 
            src="/555.png" 
            alt="Main Feature" 
            className="rounded-lg shadow-xl w-full max-w-4xl object-cover px-2 md:px-0"
          />
        </div>

        <Button 
          size="lg"
          className="bg-red-600 hover:bg-red-700 text-white text-base md:text-2xl px-4 md:px-16 py-4 md:py-8 mt-6 md:mt-8 font-bold uppercase rounded-lg transform transition-all duration-300 hover:scale-105 shadow-lg w-full sm:w-auto"
        ...
        >
          <span className="flex items-center justify-center flex-wrap">
            <span className="mr-1">Embrace Your Swaggerism-</span>
      ...
      <div className="absolute -bottom-0 left-0 w-full overflow-hidden">
        <svg
          ...
          className="relative w-full h-[80px] md:h-[280px]"
