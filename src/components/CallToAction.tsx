  ...
  return (
    <section className="py-10 md:py-20 bg-gradient-to-br from-theme-purple-darkest via-black to-theme-purple-dark text-white text-center">
      <div className="max-w-4xl mx-auto px-4 md:px-6 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-40 h-40 bg-theme-pink-DEFAULT/20 rounded-full blur-3xl"></div>
        ...
        <div className="mt-6 md:mt-8 relative z-10">
          <button
            className="bg-theme-pink-DEFAULT hover:bg-theme-pink-medium text-white text-base sm:text-xl md:text-2xl px-6 sm:px-10 md:px-16 py-4 sm:py-6 md:py-8 mt-4 md:mt-8 font-bold uppercase rounded-xl transform transition-all duration-300 hover:scale-110 shadow-xl w-full sm:w-auto animate-shimmer"
            onClick={() =>
